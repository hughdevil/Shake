		...
		<div class="row">
			<c:forEach items="${itemList}" var="item" varStatus="status">
				<div class="col-sm-6 col-md-3">
					<div class="thumbnail ">
						<a href="<%=request.getContextPath() %>/item/${item.iid}/detail.do"> <img class="img-responsive" src="<%=request.getContextPath() %>/${item.postImage}" alt="${item.iname }">
							<div class="caption">
								<h3 style="color: red">
								...
								<p style="text-align: right">${item.user.name}&nbsp;&nbsp;${item.onshelfdate }</p>
							</div>
						</a>
					</div>
				</div>
