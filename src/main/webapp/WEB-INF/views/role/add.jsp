...
<body>
	...
	<div class="container">
		...
		<!--右侧  -->
		<form:form modelAttribute="role" method="post" class="form-horizontal panel panel-default col-md-5 " onsubmit="return check();">
			<ul class="list-group">
				...
				<li class="list-group-item"><div class="row">
						...
						<div class="col-md-6">
							<form:input path="rname" type="text" class="form-control " required="required" maxlength="4" placeholder="注册角色的名称，至多4字" />
						</div>
					</div></li>
				...
				<li class="list-group-item"><div class="row">
						...
						<div class="col-md-6">
							<form:textarea path="rdesc" type="text" class="form-control " required="required" maxlength="100" rows="4" cols="100%" placeholder="注册角色的描述，至多100字" />
						</div>
					</div></li>
